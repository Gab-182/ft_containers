...
int main()
{
	...
	std::cout << BOLDGREEN << "Testing begin(): 🧮📐📏" << RESET << std::endl;
//	{
...
//	}
	std::cout << BOLDYELLOW << "—————————————————————————————————————————————" << RESET << std::endl;
	std::cout << BOLDGREEN << "Testing const begin(): 🧮📐📏" << RESET << std::endl;
	{
		ft::RedBlack<int, std::string>::const_iterator const_it = my_tree.begin();
		ft::RedBlack<int, std::string>::const_iterator const_ite = my_tree.end();
