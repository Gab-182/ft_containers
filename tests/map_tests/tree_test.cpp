...
int main()
{
	...
	std::cout << BOLDGREEN << "\nTesting tree range constructor: " << RESET << std::endl;
	...
	std::cout << BOLDRED << "\nTesting tree copy constructor: " << RESET << std::endl;
	std::cout << BOLDYELLOW << "=====================================================================" << RESET << std::endl;
	{
	...
	std::cout << BOLDGREEN << "\nTesting begin() && end(): 🧮📐📏" << RESET << std::endl;
	std::cout << BOLDYELLOW << "=====================================================================" << RESET << std::endl;
	{
...
//	}
	...
	std::cout << BOLDYELLOW << "=====================================================================" << RESET << std::endl;
	{
		std::cout << BOLDYELLOW << "Erasing [1]  -> " << BOLDRED << my_tree.erase(1)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [2]  -> " << BOLDRED << my_tree.erase(2)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [3]  -> " << BOLDRED << my_tree.erase(3)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [4]  -> " << BOLDRED << my_tree.erase(4)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [5]  -> " << BOLDRED << my_tree.erase(5)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [6]  -> " << BOLDRED << my_tree.erase(6)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [7]  -> " << BOLDRED << my_tree.erase(7)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [8]  -> " << BOLDRED << my_tree.erase(8)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [9]  -> " << BOLDRED << my_tree.erase(9)  << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [10] -> " << BOLDRED << my_tree.erase(10) << RESET << std::endl;
		std::cout << BOLDYELLOW << "Erasing [55] -> " << BOLDRED << my_tree.erase(55) << RESET << std::endl;
		
		std::cout << BOLDRED << "Printing the tree after erasing:" << RESET << std::endl;
		ft::RedBlack<int, std::string>::iterator it = my_tree.begin();
		ft::RedBlack<int, std::string>::iterator ite = my_tree.end();
		while (it != ite) {
			std::cout
	...
	std::cout << BOLDGREEN << "\nTesting the range erase()" << RESET << std::endl;
	std::cout << BOLDYELLOW << "=====================================================================" << RESET << std::endl;
	{
		ft::RedBlack<int, std::string> my_tree5;
		my_tree5.insert(ft::make_pair(1, "< A >"));
		my_tree5.insert(ft::make_pair(2, "< B >"));
		my_tree5.insert(ft::make_pair(3, "< C >"));
		my_tree5.insert(ft::make_pair(4, "< D >"));
		my_tree5.insert(ft::make_pair(5, "< E >"));
		my_tree5.insert(ft::make_pair(6, "< F >"));
		my_tree5.insert(ft::make_pair(7, "< G >"));
		my_tree5.insert(ft::make_pair(8, "< H >"));
		my_tree5.insert(ft::make_pair(9, "< I >"));
		my_tree5.insert(ft::make_pair(10, "< J >"));
		my_tree5.insert(ft::make_pair(11, "< K >"));
		my_tree5.insert(ft::make_pair(12, "< L >"));
		my_tree5.insert(ft::make_pair(13, "< M >"));
		my_tree5.insert(ft::make_pair(14, "< N >"));
		my_tree5.insert(ft::make_pair(15, "< O >"));
		my_tree5.insert(ft::make_pair(16, "< P >"));
		my_tree5.insert(ft::make_pair(17, "< Q >"));
		my_tree5.insert(ft::make_pair(18, "< R >"));
		my_tree5.insert(ft::make_pair(19, "< S >"));
		my_tree5.insert(ft::make_pair(20, "< T >"));
		my_tree5.insert(ft::make_pair(21, "< U >"));
		my_tree5.insert(ft::make_pair(22, "< V >"));
		my_tree5.insert(ft::make_pair(23, "< W >"));
		my_tree5.insert(ft::make_pair(24, "< X >"));
		my_tree5.insert(ft::make_pair(25, "< Y >"));
		my_tree5.insert(ft::make_pair(26, "< Z >"));

		std::cout << "Before erasing: " << RESET << std::endl;
		{
			ft::RedBlack<int, std::string>::iterator it = my_tree5.begin();
			ft::RedBlack<int, std::string>::iterator ite = my_tree5.end();
			while (it != ite) {
				std::cout
						<< BOLDYELLOW << "Key= " << BOLDWHITE << it->first
						<< BOLDYELLOW << ", Val= " << BOLDWHITE << it->second
		...
		std::cout << BOLDRED << "Erasing the keys from [1 -> 10]" << RESET << std::endl;
		my_tree5.erase(my_tree5.begin() + 1, my_tree5.begin() + 2);
		{
			ft::RedBlack<int, std::string>::iterator it = my_tree5.begin();
			ft::RedBlack<int, std::string>::iterator ite = my_tree5.end();
			while (it != ite) {
