...
int main()
{
	...
	{ // 3. (Test the fill constructor):
		...
		std::vector<int> mv3(5, 10);
		
		assert(mv3.size() == 5);
		
		for (std::vector<int>::size_type i = 0; i < mv3.size(); i++)
			assert(mv3[i] == 10);
		for (std::vector<int>::size_type i = 0; i < mv3.size(); i++)
		 ...
		 * ! [string vector] 
		 *!===================*/
		std::vector<std::string> mv2_str(5, "hello");
	...
	std::vector<int> mv4(vec.begin(), vec.begin() + 5);
	assert(mv4.size() == 5);
	...
	for (std::vector<int>::size_type i = 0; i < mv4.size(); i++)
	...
	std::vector<std::string> mv4_str(arr_str.begin(), arr_str.begin() + 5);
	...
	assert(mv4_str[3] == "!");
	assert(mv4_str[4] == "!");
	for (std::vector<int>::size_type i = 0; i < mv4_str.size(); i++)
	...
	{ // 5. (Test the copy constructor):
		...
		assert(mv5[3] == 10);
		assert(mv5[4] == 10);
		for (std::vector<int>::size_type i = 0; i < mv5.size(); i++)
	...
	{ // 6. (Test the operator=):
		...
		assert(mv6[0] == 10);
		assert(mv6[1] == 10);
		for (std::vector<int>::size_type i = 0; i < mv6.size(); i++)
	...
	{ // 7.8. (Test the push_back function) && (Test the pop_back function):
		...
		for (std::vector<int>::size_type i = 0; i < mv7.size(); i++)
		...
		for (std::vector<int>::size_type i = 0; i < mv8.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < v12.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < v13.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < v14.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < v20.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < mv21.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < mv22.size(); i++)
	...
	std::vector<int>::iterator it = mv23.begin();
	std::vector<int>::iterator ite = mv23.end();
	...
	std::vector<int>::reverse_iterator rev_it = mv24.rbegin();
	...
	std::vector<int> mv25(3);
	
	mv25[0] = 10;
	mv25[1] = 20;
	mv25[2] = 30;
	
	std::vector<int>::const_iterator const_it = mv25.begin();
...
//		std::cout << BOLDWHITE << "mv30.back() = " << mv30.back() << RESET << std::endl;
	...
	try {
		...
		std::vector<int> mv31(3);
		
		mv31[0] = 10;
		mv31[1] = 20;
		mv31[2] = 30;
		
		std::vector<int>::const_reference const_ref = mv31.front();
		std::cout << BOLDWHITE << "mv31.front() = " << const_ref << RESET << std::endl;

//		std::vector<int> mv32;
//		std::vector<int>::const_reference const_ref2 = mv32.front();
//		std::cout << BOLDWHITE << "mv32.front() = " << const_ref2 << RESET << std::endl;
	...
	try {
		...
		std::vector<int> mv33(3);
		
		mv33[0] = 10;
		mv33[1] = 20;
		mv33[2] = 30;
		
		std::vector<int>::const_reference const_ref = mv33.back();
		std::cout << BOLDWHITE << "mv33.back() = " << const_ref << RESET << std::endl;

//		std::vector<int> mv34;
//		std::vector<int>::const_reference const_ref2 = mv34.back();
//		std::cout << BOLDWHITE << "mv34.back() = " << const_ref2 << RESET << std::endl;
	...
	std::vector<int> mv37(3);
	
	mv37[0] = 10;
	mv37[1] = 20;
	mv37[2] = 30;
	
	std::vector<int>::const_pointer const_ptr = mv37.data();
	std::cout << BOLDWHITE << "mv37.data() = " << const_ptr << RESET << std::endl;
	// if (size() = 0)
	std::vector<int> mv38;
	
	std::vector<int>::const_pointer const_ptr2 = mv38.data();
	...
	std::vector<int>::iterator ers_it1 = mv39.erase(mv39.begin());
	std::cout << BOLDWHITE << "mv39.erase(mv39.begin()) = " << *ers_it1 << RESET << std::endl;
	for (std::vector<int>::size_type i = 0; i < mv39.size(); i++)
		std::cout << BOLDWHITE << "mv39[i] = " << mv39[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	std::vector<int>::iterator ers_it2 = mv39.erase(mv39.begin());
	for (std::vector<int>::size_type i = 0; i < mv39.size(); i++)
		std::cout << BOLDWHITE << "mv39[i] = " << mv39[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	...
	std::vector<int>::iterator ers_it3 = mv40.erase(mv40.begin(), mv40.begin() + 2);
	for (std::vector<int>::size_type i = 0; i < mv40.size(); i++)
		std::cout << BOLDWHITE << "mv40[" << i << "] = " << mv40[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	std::vector<int>::iterator ers_it4 = mv40.erase(mv40.begin(), mv40.begin() + 2);
	for (std::vector<int>::size_type i = 0; i < mv40.size(); i++)
		std::cout << BOLDWHITE << "mv40[" << i << "] = " << mv40[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	...
	std::vector<int>::iterator ins_it1 = mv41.insert(mv41.begin(), 100);
	
	for (std::vector<int>::size_type i = 0; i < mv41.size(); i++)
		std::cout << BOLDWHITE << "mv41[" << i << "] = " << mv41[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	
	std::vector<int>::iterator ins_it2 = mv41.insert(mv41.begin() + 2, 200);
	
	for (std::vector<int>::size_type i = 0; i < mv41.size(); i++)
		std::cout << BOLDWHITE << "mv41[" << i << "] = " << mv41[i] << RESET << std::endl;
	std::cout << "----------------------------" << std::endl;
	
	std::vector<int>::iterator ins_it3 = mv41.insert(mv41.end(), 300);
	...
	for (std::vector<int>::size_type i = 0; i < mv42.size(); i++)
	...
	for (std::vector<int>::size_type i = 0; i < mv44.size(); i++)
	...
	std::vector<int> mv45(5, 1);
	std::vector<int> mv46(5, 2);
	std::vector<int> mv47(5, 1);
	...
	std::vector<int> mv48(5, 1);
	std::vector<int> mv49(5, 2);
	std::vector<int> mv50(5, 1);
	...
	std::vector<int> mv51(5, 1);
	std::vector<int> mv52(5, 2);
	std::vector<int> mv53(5, 1);
	...
	std::vector<int> mv54(5, 1);
	std::vector<int> mv55(5, 2);
	std::vector<int> mv56(5, 1);
	...
	std::vector<int> mv57(5, 1);
	std::vector<int> mv58(5, 2);
	std::vector<int> mv59(5, 1);
