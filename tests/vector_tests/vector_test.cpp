...
int main()
{
	...
	{ // 3. (Test the fill constructor):
		...
		for (ft::vector<int>::size_type i = 0; i < mv3.size(); i++)
			assert(mv3[i] == 10);
		for (ft::vector<int>::size_type i = 0; i < mv3.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv4.size(); i++)
	...
	assert(mv4_str[3] == "!");
	assert(mv4_str[4] == "!");
	for (ft::vector<int>::size_type i = 0; i < mv4_str.size(); i++)
	...
	{ // 5. (Test the copy constructor):
		...
		assert(mv5[3] == 10);
		assert(mv5[4] == 10);
		for (ft::vector<int>::size_type i = 0; i < mv5.size(); i++)
	...
	{ // 6. (Test the operator=):
		...
		assert(mv6[0] == 10);
		assert(mv6[1] == 10);
		for (ft::vector<int>::size_type i = 0; i < mv6.size(); i++)
	...
	{ // 7.8. (Test the push_back function) && (Test the pop_back function):
		...
		for (ft::vector<int>::size_type i = 0; i < mv7.size(); i++)
	...
	/*==================================================================================================================*/
		...
		for (ft::vector<int>::size_type i = 0; i < mv8.size(); i++)
	...
	/*==================================================================================================================*/
	 ...
	 for (ft::vector<int>::size_type i = 0; i < v12.size(); i++)
	 ...
	 for (ft::vector<int>::size_type i = 0; i < v13.size(); i++)
	 ...
	 for (ft::vector<int>::size_type i = 0; i < v14.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv21.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv22.size(); i++)
...
//		std::cout << BOLDWHITE << "mv34.back() = " << const_ref2 << RESET << std::endl;
	...
	for (ft::vector<int>::size_type i = 0; i < mv39.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv40.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv41.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv42.size(); i++)
	...
	for (ft::vector<int>::size_type i = 0; i < mv44.size(); i++)
